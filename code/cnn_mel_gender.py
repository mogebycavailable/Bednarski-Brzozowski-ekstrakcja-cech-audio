...
# %%
def load_model():
    cnn_gender_mel_model = Sequential([
        ...
        layer.Conv2D(256, (3,3), padding='same', activation='relu'),
        layer.BatchNormalization(),
...
def load_callbacks():
    ...
    checkpoint = ModelCheckpoint(
        filepath='weights/best_mel_cnn_model.keras',
        monitor='val_loss',
        save_best_only=True,
        mode='min',
        verbose=1
